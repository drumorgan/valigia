// MIRROR of src/forecast-math.js — DO NOT EDIT DIRECTLY.
// The cron-send-alerts edge function needs the v3 restock estimators
// server-side, and Supabase's function bundler can only reach files
// under supabase/functions/. When src/forecast-math.js changes, re-copy:
//   cp src/forecast-math.js supabase/functions/_shared/forecast-math.js
//   (keeping this header). Pure ESM JS — Deno imports it natively.
